...
def parser_args(): 
    ...
    parser.add_argument('--nPeriods', type=int, default=13, help='Number of periods for attending the emergency')
    parser.add_argument('--nProfiles', type=int, default=23, help='Number of profiles that exists in the roster')
    parser.add_argument('--maxPeriods', type=int, default=3, help='Maximum number of periods that a person can work')
    parser.add_argument('--minPeriods', type=int, default=2, help='Minimum number of periods that a person can work')
    parser.add_argument('--nPeople', type=int, default=200, help='Number of people that exists in the roster')
    parser.add_argument('--Discount', type=int, default=40, help='Discount for the cost of the charter')
    parser.add_argument('--nDiscount', type=int, default=30, help = ' Minimum number of persons for the discount')

    parser.add_argument('--nCharter', type=int, default=3, help='Number of charter that exists in the roster')
    parser.add_argument('--minCapacity', type=list, default=[0,0,0], help='Minimum capacity of the charter')
    parser.add_argument('--maxCapacity', type=list, default=[200,120,90], help='Maximum capacity of the charter')
    ...
    parser.add_argument('--output_path', type=str, default='simultated_data.xlsx', help='Path for the output files')
