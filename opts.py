...
def parser_args(): 
    ...
    parser.add_argument('--nPeriods', type=int, default=10, help='Number of periods for attending the emergency')
    ...
    parser.add_argument('--nPeople', type=int, default=510, help='Number of people that exists in the roster')
    ...
    parser.add_argument('--ratio', type=int, default=10, help='Ratio of the people for each profile')
    ...
    parser.add_argument('--maxCapacity', type=list, default=[3,90], help='Maximum capacity of the charter')
    parser.add_argument('--CostCharter1', type=int, default=75000, help='Cost of the first charter')
    parser.add_argument('--CostCharter2', type=int, default=180000, help='Cost of the second charter')

    parser.add_argument('--profile_path', type=str, default='profiles_EMT2.xlsx', help='Path that contains the profiles file')
    parser.add_argument('--output_path', type=str, default='Simulate_data.xlsx', help='Path for the output files')
